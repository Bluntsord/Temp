...
set_target_properties(arrow_python_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libarrow_python.700.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libarrow_python.700.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS arrow_python_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_arrow_python_shared "${_IMPORT_PREFIX}/lib/libarrow_python.700.0.0.dylib" )
