...
set_target_properties(arrow_dataset_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libarrow_dataset.700.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libarrow_dataset.700.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS arrow_dataset_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_arrow_dataset_shared "${_IMPORT_PREFIX}/lib/libarrow_dataset.700.0.0.dylib" )
