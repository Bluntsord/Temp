...
set_target_properties(gandiva_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgandiva.700.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libgandiva.700.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gandiva_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_gandiva_shared "${_IMPORT_PREFIX}/lib/libgandiva.700.0.0.dylib" )
